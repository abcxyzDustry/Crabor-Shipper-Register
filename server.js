...
function getPartnerModel(mod) {
  const slug = {
    gl: GiatLa, gv: GiupViec, cs: ChinaShop, fd: FoodPartner,
    giat_la: GiatLa, giup_viec: GiupViec, china_shop: ChinaShop, food_partner: FoodPartner
  };
  return slug[mod] || null;
}

function slugify(fe) {
  return { gl: 'giat_la', gv: 'giup_viec', cs: 'china_shop', fd: 'food_partner' }[fe] || fe;
}
